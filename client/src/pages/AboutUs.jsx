...
import bg from '../assets/aboutus bg.mp4'
function AboutUs() {
  return (
    <> 

        <div className="text-center h-[70vh] bg-black text-white flex justify-center items-center">
          ...
          <div className="w-3/4 flex flex-col items-center justify-center gap-y-6 relative z-10">
            <h1 className='  text-7xl text-white font-black mx-auto p-2 rounded-3xl  mt-5 '>ABOUT US</h1>
              <div className="mx-auto lg:w-auto lg:mt-3"> 
                  <h1 className='font-bold text-white text-3xl mb-3'>Mission statement</h1>
              ...
              <div className="">
                  <h1 className='font-bold text-white text-3xl mb-3'>Vision statement</h1>
